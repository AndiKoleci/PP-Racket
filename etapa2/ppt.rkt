...
;     |-2 2 3| |5|   |17|
(define (multiply M V)
  ;se face cu foldr, cu cons
  ;pot is cu map
  (foldl (λ (x acc) (append acc (list (dot-product x V)))) null M)
  )
...
(define (get-nth-ppt-from-matrix-transformations n)
  ((get-nth-tuple n '(3 4 5)) (λ(tuple) (multiply T1 tuple)) (λ(tuple) (multiply T2 tuple)) (λ(tuple) (multiply T3 tuple)))
  )
;n last param
;curry, mult, T1
...
(define (get-nth-quadruple n)
  ((get-nth-tuple n '(1 1 2 3)) (λ(tuple) (apply Q1 tuple)) (λ(tuple) (apply Q2 tuple)) (λ(tuple) (apply Q3 tuple)))
  )
;n last param
